...
- `internal/config/` – env/viper config loader + validation.
...
- Authenticated (Bearer token):
  - `POST /api/v1/transactions` with `Idempotency-Key: <uuid>` and body:
    ```json
    { "amount": 1000, "currency": "USD", "method": "visa", "visa": { "card_last_4": "4242", "card_network": "visa", "authorization_code": "abc", "reference_id": "ref-1", "is_3d_secure": true } }
    ```
